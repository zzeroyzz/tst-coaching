// app/habits/layout.tsx - Habit tracker layout with neo-brutalist styling  
// FORCE UPDATE: 2025-08-20-22:31 - Profile tab should be visible now
"use client";
...
// Profile tab configuration - updated to fix hydration issues
const tabs = [
  {
    name: "Today",
    href: "/habits",
